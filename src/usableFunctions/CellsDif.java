...
public class CellsDif {
    ...
    public static int DifOfCells(int DifOfCells, int input_row_now_int, int input_column_now_int,
        ...
        if ((input_column_new_int == 0 && input_column_now_int == 0) || (input_column_new_int == 1 && input_column_now_int == 0)) {
        ...
        } else if ((input_column_new_int == 1 && input_column_now_int == 1) || (input_column_new_int == 2 && input_column_now_int == 2)){
            DifOfCells = input_column_now_int * 10 + input_row_now_int - (input_column_new_int * 10 + input_row_new_int);
